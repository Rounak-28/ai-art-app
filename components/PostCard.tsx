...
const PostCard = ({ img }: any) => {
  return (
    <div className="py-2 rounded-lg w-fit mx-auto cursor-pointer relative">
      <Image
        src={`/images/${img}.png`}
        width={400}
        height={400}
      ...
      />
      <div className="top w-full absolute top-0 p-4 flex items-center justify-between">
      ...
      <p className="prompt absolute bottom-0 p-4">
